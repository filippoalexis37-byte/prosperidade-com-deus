      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-gradient-gold rounded-3xl p-8 md:p-10 text-primary-foreground flex flex-col justify-center text-center shadow-gold">
            ...
            <div className="mb-10">
              <p className="text-primary-foreground/60 text-lg line-through font-bold mb-1">R$ 97,00</p>
              <h3 className="text-6xl md:text-7xl font-serif font-black drop-shadow-md mb-2">R$ 49,90</h3>
              <p className="text-primary-foreground/80 font-medium italic">Acesso vitalício — pagamento único</p>
            </div>
